...
FamilyRec2 := recformat<
    ...
    M, AOfMF, quogroup, quomap, dataforquotient,
    CPname: MonStgElt   
    >;	 
...
function CreateFamilyRecSubgroupWithQuo(calG, B ,Hc,W,CPname : compute_comm:=false, compute_calgmeetsl2:=false)   
 /*
    Input:
 ...
 */
      ...
      F := rec<FamilyRec2 | calG:= calG ,B:=B >;	 
