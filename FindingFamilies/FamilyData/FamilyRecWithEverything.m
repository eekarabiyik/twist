...
FamilyRecF := recformat<
    ...
    //AOfMF: this contains the transformation matrices of the vector space generated by M`F. It is used for the computation of the cocycle
