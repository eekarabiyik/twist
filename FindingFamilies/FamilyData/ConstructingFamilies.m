...
function gl2QImagesForFamiliiesEray(GGG,H)
    GGG`SL:=true;
    H`SL:=true;
    SL2ContainsNegativeOne(H) and SL2ContainsNegativeOne(GGG);
    N1:=SL2Level(GGG);
...
//Make this better I don't know. Maybe also consider the comm subgroups, to make it easier to compute the comm subgroups afterwards
//Need to find the commutator subgroups here too I guess.
X:=AssociativeArray();
...
//Checking the genus and so on make it optimal.
