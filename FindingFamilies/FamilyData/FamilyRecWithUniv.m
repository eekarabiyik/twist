...
FamilyRecUniv := recformat<
    ...
    M, calGModCurve, AOfMF, quogroup, quomap, dataforquotient, conjugacyofB, AOfMFCanModel, CanModelForHyp, RelativeJMap, JmapcalG, parentcalG, skeleton, parentrelmapcalG, label
    ...
    //RelativeJMap: The map pi: X_H -> X_calG
    //parentcalG: A parent of calG, it is an oepn subgroup of GL2(Zhat) that contains calG as a maximal subgroup
    //JmapcalG: If assigned this is the map X_calG -> P^1
