...
load "../OpenImage/precomputation/ComputeFrobData.m";  // Loads all functions we need (may take a bit!)
...
I:=Open("../OpenImage/data-files/frob_data.dat", "r"); 
...
I:=Open("../OpenImage/data-files/agreeable_closures_exceptional.dat", "r");
repeat
...
ExceptionalImages:=[];
I:=Open("../OpenImage/data-files/exceptional_images.dat", "r");
repeat
	b,y:=ReadObjectCheck(I);
	if b then
