...
* "model" -- Crv Eray: this is the model of the curve. 
* "j" -- SeqEnum, [jnum, jdenom] Eray: The jmap of the curve
* "f" -- SeqEnum, weight 3 form in M_3(G) expressed as [fnum, fdenom] Eray: I now have a code for it but I need to check it.
*/
function FindUnivECModel(M0, model, j_map, f: verbose:=false)
        ...
        a_inv := FinalReduction(C,M0`G,QC,polyring,newA2num,newA2denom,newB2num,newB2denom);//can input the group BUT BE CAREFUL ABOUT CONJUGATION
